  ...
  if (object.matches.length === 0) {
    return (
      <div>
        ...
        {/* Раньше здесь всегда писали про пустой каталог, хотя чаще всего причина другая:
            похожего не нашлось, а иногда и самого предмета в комнате нет. */}
        <p className="mt-2 text-[15px] leading-relaxed text-ink-2">
          Подходящего товара в свежем каталоге не нашлось. Старые цены и наличие не используем для
          новых рекомендаций. Можно вернуться после обновления каталога.
        </p>
      </div>
    )
  }
