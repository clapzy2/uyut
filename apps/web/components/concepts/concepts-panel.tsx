  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {canGenerate ? (
        <p className="text-[15px] leading-relaxed text-ink-2">
          {!hasPhoto
            ? 'Без фото это концепт с нуля: учитываем тип комнаты, указанные размеры и описание окон и дверей в мерках. Перед генерацией проверьте эти данные. Картинка не заменяет точный чертёж; фото поможет сохранить вид вашей комнаты.'
            : keepsFurniture
