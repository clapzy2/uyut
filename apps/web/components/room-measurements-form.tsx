    ...
    <form onSubmit={submit} noValidate className="flex flex-col gap-4">
      <fieldset disabled={saving} className="flex min-w-0 flex-col gap-4">
        ...
        <p className="-mt-1 text-[13px] leading-relaxed text-ink-2">
          Стороны комнаты подставляются с плана, если он загружен. По ним видно только то, что
          предмет шире самой длинной стены и не встанет никуда. Чтобы услышать «встанет», нужен
          промеренный участок.
        </p>
