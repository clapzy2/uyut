...
Проект находится на стадии ограниченного MVP. Единые требования: [продуктовая спецификация](docs/PRODUCT_SPEC.md), текущие этапы и готовность: [roadmap](docs/ROADMAP.md).
