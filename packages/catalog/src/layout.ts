      ...
      ? {
          ...
          detail:
            ...
            (hasMissingRequiredFunction
              ? 'Добавьте предметы для обязательных функций комнаты, отмеченных ниже.'
              : reservationSource === 'none'
                ? 'Укажите положение дверей, окон и радиаторов, чтобы проверить проходы и свободное место у стен.'
                : 'Укажите габариты и рабочие зоны выбранных предметов, чтобы завершить проверку.'),
        }
      : hasPreliminary
        ? {
            status: 'preliminary',
