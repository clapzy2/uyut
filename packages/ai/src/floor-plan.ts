...
- obstacles — только неподвижные объёмы внутри квартиры: явно обозначенная несущая колонна (column), вентиляционная/инженерная шахта или короб (shaft), либо другой подписанный несдвигаемый выступ (fixed).
