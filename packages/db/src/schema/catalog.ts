...
export type CatalogAttributes = {
  ...
  /**
   * Откуда взялись габариты товара. Выделенные поля фида надёжнее числа,
   * которое пришлось извлечь из названия, описания или общей строки «Габариты».
   */
  dimensionsSource?: Partial<
    Record<'width' | 'depth' | 'height', 'store-parameters' | 'store-text'>
  >
  /**
